...
1. Follow [Server Installation](/user/server_installation) to install the GC.
2. Read [Servers and Lobbies](/user/servers) for more information.

## Important warning

Release packages replace launcher executables such as `csgo.exe`, `srcds.exe`, or platform equivalents. Back up the original files first.