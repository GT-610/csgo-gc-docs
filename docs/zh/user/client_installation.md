...
通过 Steam 商店安装旧版 CS:GO 应用。你可以在 Steam 商店直接搜索，也可以通过[此链接](https://store.steampowered.com/app/4465480/CounterStrikeGlobal_Offensive/)打开商店页面。
...
如果一切正常，你会在控制台看到带有 `[GC]` 字样的绿色日志，并能顺利进入大厅和库存页面。在库存中，你还会看到一个“爪子刀 - 渐变之色”物品。

## macOS 说明

macOS 可能会弹出权限提示并阻止运行，需要你在系统安全流程中手动允许。
